...
const PinContainer = ({
  ...
  // Step 2: Set mounted state to true after the component mounts
  useEffect(() => {
    setMounted(true);
  }, []);

  // Step 3: Return null (or a loading spinner) if the component is not yet mounted
